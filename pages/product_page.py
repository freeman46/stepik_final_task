...
class ProductPage(BasePage):
    ...
    def should_be_success_message(self):
        ...
        assert product_name_in_alert == product_name_in_card, f'Ожидалось:{product_name_in_card}, Факт:{product_name_in_alert}'
    ...
    def should_be_cost_product(self):
        ...
        assert cost_basket_in_alert == cost_product_in_card, f'Ожидаемая цена в корзине:{cost_product_in_card}, Факт:{cost_basket_in_alert}'
